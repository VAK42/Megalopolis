...
class WalletTopUpSuccessScreen extends ConsumerWidget {
 ...
 const WalletTopUpSuccessScreen({super.key, required this.amount, required this.newBalance, required this.method, required this.transactionId});
 @override
    ...
    child: Padding(
     ...
     child: Column(
      ...
      children: [
       ...
       const Text(
        WalletConstants.topUpSuccessful,
        textAlign: TextAlign.center,
        style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold),
       ),
       const SizedBox(height: 12),
       Text(
        WalletConstants.topUp,
       ...
       Container(
        ...
        child: Column(
         children: [
          ...
          const Divider(),
          const SizedBox(height: 8),
          _buildDetailRow(WalletConstants.selectMethod, method),
          const SizedBox(height: 8),
          _buildDetailRow(WalletConstants.newBalance, '${WalletConstants.currencySymbol}${newBalance.toStringAsFixed(2)}'),
          const SizedBox(height: 8),
       ...
       const SizedBox(height: 12),
       AppButton(text: WalletConstants.download, onPressed: () {}, isOutline: true, icon: Icons.download),
      ],
     ),
    ),
   ),
