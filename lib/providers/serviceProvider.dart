...
final servicesProvider = FutureProvider.family<List<ItemModel>, String?>((
  ref,
  category,
) async {
...
final serviceItemProvider = FutureProvider.family<ItemModel?, int>((
  ref,
  serviceId,
) async {
  final repository = ref.watch(serviceRepositoryProvider);
...
final serviceCategoriesProvider = FutureProvider<List<Map<String, dynamic>>>((
  ref,
) async {
  final repository = ref.watch(serviceRepositoryProvider);
...
class ServiceBookingNotifier extends Notifier<Map<String, dynamic>> {
  ...
  void setService(int serviceId, String serviceName, double price) {
    state = {
      ...state,
      'serviceId': serviceId,
  ...
  void setProvider(int providerId, String providerName) {
  ...
  Future<int?> bookService(int userId) async {
    try {
      final booking = {
        ...state,
        'userId': userId,
...
final serviceBookingProvider =
  NotifierProvider<ServiceBookingNotifier, Map<String, dynamic>>(() {
